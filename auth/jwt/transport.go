...
import (
	...
	"dev.azure.com/vib-lz-devops/B08-DSC-Project-SmartCollection/_git/smartcollection-base-go.git/transport/grpc"
	"dev.azure.com/vib-lz-devops/B08-DSC-Project-SmartCollection/_git/smartcollection-base-go.git/transport/http"
)
...
func HTTPToContext() http.RequestFunc {
	return func(ctx context.Context, r *stdhttp.Request) context.Context {
		...
		return context.WithValue(ctx, local.Getenv("KEY_VAULT_JWT_TOKEN_CONTENT_KEY"), token)
	}
}
...
func GRPCToContext() grpc.ServerRequestFunc {
	return func(ctx context.Context, md metadata.MD) context.Context {
		...
		if ok {
			ctx = context.WithValue(ctx, local.Getenv("KEY_VAULT_JWT_TOKEN_CONTENT_KEY"), token)
		}
